...
export const SET_VISUALS = {
  ...
  u1_feelings:             { iconKey: "mood",      accent: "yellow" },
  ...
  u2_art:                  { iconKey: "palette",   accent: "purple" },
  u2_art_artists_extra:    { iconKey: "palette",   accent: "purple" },

  // UNIT 3
  u3_activities:                 { iconKey: "activity", accent: "mint" },
  ...
  // UNIT 4
  u4_personality:            { iconKey: "person",  accent: "purple" },
  ...
  // UNIT 6
  u6_body:                    { iconKey: "fitness",  accent: "orange" },
  ...
  // UNIT 7
  u7_learning:              { iconKey: "cap",     accent: "purple" },
