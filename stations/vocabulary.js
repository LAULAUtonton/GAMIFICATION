...
export const VOCAB_DB = {
  meta: {
    ...
    locale_notes: "Canarias-friendly (you can add local examples later)",
    version: "1.0.0"
  },
  ...
  units: [
    ...
    // =========================
    // UNIT 8 — (Summer holidays / school events)
    // =========================
    {
      unit: 8,
      title: "Unit 8",
...
// Optional helper (useful for bulk flashcards)
      ...
      if (set.type === "pairs") {
        ...
        for (const item of set.items) {
          out.push({
            ...
            type: set.type,
            front: item,
            back: "" // you can auto-fill definitions/translations later
          });
        }
      }
    }
